...
// v3.35-v3.36 used "extern \"C\" { #include \"fishhook.c\" }" — this wrapped
// fishhook.c's system headers (<mach/mach.h>, <dlfcn.h>, etc.) inside extern "C",
// which caused the compiler to silently skip generating fishhook code.
// Mach-O __TEXT,__text section size was identical to versions without fishhook.
//
// v3.37 FIX: system headers are at the top of this .mm file (outside extern "C"),
// fishhook.h is included normally (it has its own extern \"C\" guards),
// and fishhook.c function bodies are inlined here with explicit extern "C".
// Safe because constructor checks iOS version at runtime; only activates on iOS < 13.4.
#include "fishhook.h"

// ---- fishhook.c inlined code (type aliases + struct + functions) ----
