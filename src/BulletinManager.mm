...
- (instancetype)init {
    ...
    if (self) {
        ...
        // UNUserNotificationCenter initWithBundleIdentifier: is a private API
        // Fallback to default center if unavailable
        @try {
            mNotificationCenter = [[UNUserNotificationCenter alloc] initWithBundleIdentifier:mSectionIdentifier];
        } @catch (NSException *exception) {
            mNotificationCenter = [UNUserNotificationCenter currentNotificationCenter];
        }
